...
public class StoreProgramService {
	...
	public List<StoreProgramVo> selectPromotionList(StoreProgramDto storeProgramDto){
	...
	public JSONObject insertStoreProgram(StoreProgramDto storeProgramDto, HttpServletRequest request) {
		...
		storeProgramDto.setRegId(SessionUtil.getSessionStaffVo(request).getStaffId());
		//프로모션 정보 INSERT
	...
	public JSONObject updateStoreProgram(StoreProgramDto storeProgramDto, HttpServletRequest request) {
		...
		storeProgramDto.setUpdId(SessionUtil.getSessionStaffVo(request).getStaffId());
